...
┃◈┃
┃◈┃ _*Options for privacy commands:*_
┃◈┃• _all - Everyone_
┃◈┃• _contacts - My contacts only_
┃◈┃• _contact_blacklist - Contacts except blocked_
┃◈┃• _none - Nobody_
┃◈┃• _match_last_seen - Match last seen_
┃◈└───────────┈⊷
╰──────────────┈⊷
> *Lααɾα ᴍᴅ*`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://github.com/manpakaya/Lara_Data_Base/raw/refs/heads/main/20250224_162020.jpg` }, // Replace with privacy-themed image if available
                caption: privacyMenu,
                contextInfo: {
...
async (conn, mek, m, { from, isOwner, reply }) => {
    ...
    try {
        ...
        reply(`*📋 LARA-MD BLOCKED USERS 👥 FIND ! (${count}):*\n\n${list}`);
    } catch (err) {
        console.error(err);
...
cmd({
    ...
    try {
        ...
        return reply(`LARA-MD BIO FIND! USER  BIO:\n\n${about.status}`);
    } catch (error) {
